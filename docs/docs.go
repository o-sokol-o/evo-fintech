...
const docTemplate = `{
    ...
    "definitions": {
        ...
        "domain.FilterSearchInput": {
            ...
            "properties": {
                "payment_narrative": {
                    "description": "частково вказаному",
                    "type": "string",
                    "example": "договору про надання послуг А11/27123"
                },
                "payment_type": {
                    "type": "string",
                    "enum": [
        ...
        "domain.Period": {
            ...
            "properties": {
                "from": {
                    "description": "по періодам (from/to), наприклад: from 2022-08-12, to 2022-09-01 повинен повернути всі транзакції за вказаний період",
                    "type": "string",
                    "example": "2022-08-23T11:56:00.000Z"
                },
                "to": {
                    "type": "string",
